...
if ( ! function_exists( 'x_business_get_option' ) ) :
	 ...
	 */
	function x_business_get_option( $key ) {
...
if ( ! function_exists( 'x_business_get_default_theme_options' ) ) :
	 ...
	 */
	function x_business_get_default_theme_options() {
		...
		$defaults['readmore_text']    	= esc_html__( 'Read More', 'x-business' );

		// Footer.
		$defaults['copyright_text'] 	= esc_html__( 'Copyright &copy; All rights reserved.', 'x-business' );
		...
		$defaults['slider_readmore_text']    		= esc_html__( 'Read more', 'x-business' );
