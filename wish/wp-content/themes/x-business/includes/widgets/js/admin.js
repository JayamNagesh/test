...
jQuery(function($){
  ////////////////////////////////
      ...
      jQuery(document).on('click', 'input.select-img', function( event ){
        ...
        var XBusinessImage = wp.media.controller.Library.extend({
            defaults :  _.defaults({
        ...
        x_business_file_frame = wp.media.frames.x_business_file_frame = wp.media({
          button: {
        ...
        x_business_file_frame.on( 'select', function() {

          var state = x_business_file_frame.state('rtam-insert-image');
