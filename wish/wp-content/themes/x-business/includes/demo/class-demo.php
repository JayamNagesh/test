...
if ( ! class_exists( 'X_Business_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class X_Business_Demo {

		/**
		 * Singleton instance of X_Business_Demo.
		 *
		 * @var X_Business_Demo $instance X_Business_Demo instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof X_Business_Demo ) ) {
				self::$instance = new X_Business_Demo();
